// $ANTLR 3.4 Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g 2015-06-10 12:47:09
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public String getGrammarFileName() { return "Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g"; }
    ...
    // $ANTLR start "all"
    // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:9:1: all : ^( RIDDLE riddle riddle riddle riddle riddle riddle ) ;
    public final symbolTransformWalker.all_return all() throws RecognitionException {
        ...
        try {
            // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:9:5: ( ^( RIDDLE riddle riddle riddle riddle riddle riddle ) )
            // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:9:7: ^( RIDDLE riddle riddle riddle riddle riddle riddle )
            {
    ...
    // $ANTLR start "riddle"
    // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:11:1: riddle : ( ^( EQ_SIGN ^( PLUS_SIGN char_block char_block ) char_block ) | ^( EQ_SIGN ^( MINUS_SIGN char1= char_block char2= char_block ) char3= char_block ) -> ^( EQ_SIGN[\"=\"] ^( PLUS_SIGN[null, \"+\"] $char2 $char3) $char1) );
    public final symbolTransformWalker.riddle_return riddle() throws RecognitionException {
        ...
        try {
            // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:11:8: ( ^( EQ_SIGN ^( PLUS_SIGN char_block char_block ) char_block ) | ^( EQ_SIGN ^( MINUS_SIGN char1= char_block char2= char_block ) char3= char_block ) -> ^( EQ_SIGN[\"=\"] ^( PLUS_SIGN[null, \"+\"] $char2 $char3) $char1) )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:11:10: ^( EQ_SIGN ^( PLUS_SIGN char_block char_block ) char_block )
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:12:13: ^( EQ_SIGN ^( MINUS_SIGN char1= char_block char2= char_block ) char3= char_block )
                    {
                    _last = (CommonTree)input.LT(1);
                    {
                    CommonTree _save_last_1 = _last;
                    ...
                    // AST REWRITE
                    // elements: EQ_SIGN, char1, char3, char2
                    // token labels: 
                    ...
                    {
                        // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:12:94: ^( EQ_SIGN[\"=\"] ^( PLUS_SIGN[null, \"+\"] $char2 $char3) $char1)
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        ...
                        // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:12:109: ^( PLUS_SIGN[null, \"+\"] $char2 $char3)
                        {
                        CommonTree root_2 = (CommonTree)adaptor.nil();
    ...
    // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:15:1: char_block : ^( CHAR_BLOCK ( CHAR )* ) ;
    public final symbolTransformWalker.char_block_return char_block() throws RecognitionException {
        ...
        try {
            // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:16:2: ( ^( CHAR_BLOCK ( CHAR )* ) )
            // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:16:4: ^( CHAR_BLOCK ( CHAR )* )
            {
            root_0 = (CommonTree)adaptor.nil();
            ...
            if ( input.LA(1)==Token.DOWN ) {
                match(input, Token.DOWN, null); 
                // Z:\\win7\\ci\\Aufgabe4\\symbolTransformWalker.g:16:17: ( CHAR )*
                loop2:
                do {
                    int alt2=2;

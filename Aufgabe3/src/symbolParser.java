// $ANTLR 3.4 /home/tim/projects/ci/Aufgabe3/symbol.g 2015-05-20 12:37:33
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public String getGrammarFileName() { return "/home/tim/projects/ci/Aufgabe3/symbol.g"; }
    ...
    // /home/tim/projects/ci/Aufgabe3/symbol.g:25:1: char_block : ( CHAR )* -> ^( CHAR_BLOCK ( CHAR )* ) ;
    public final symbolParser.char_block_return char_block() throws RecognitionException {
        ...
        try {
            // /home/tim/projects/ci/Aufgabe3/symbol.g:26:2: ( ( CHAR )* -> ^( CHAR_BLOCK ( CHAR )* ) )
            // /home/tim/projects/ci/Aufgabe3/symbol.g:26:4: ( CHAR )*
            {
            // /home/tim/projects/ci/Aufgabe3/symbol.g:26:4: ( CHAR )*
            loop1:
            do {
            ...
            {
                // /home/tim/projects/ci/Aufgabe3/symbol.g:26:13: ^( CHAR_BLOCK ( CHAR )* )
                {
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:26:26: ( CHAR )*
    ...
    // /home/tim/projects/ci/Aufgabe3/symbol.g:28:1: line_sign : ( PLUS_SIGN | MINUS_SIGN );
    public final symbolParser.line_sign_return line_sign() throws RecognitionException {
        ...
        try {
            // /home/tim/projects/ci/Aufgabe3/symbol.g:29:2: ( PLUS_SIGN | MINUS_SIGN )
            // /home/tim/projects/ci/Aufgabe3/symbol.g:
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    public final symbolParser.all_return all() throws RecognitionException {
        ...
        try {
            // /home/tim/projects/ci/Aufgabe3/symbol.g:31:5: (char1= char_block sign1= line_sign char2= char_block EQ_SIGN char3= char_block NEW_LINE sign2= line_sign sign3= line_sign sign4= line_sign NEW_LINE char4= char_block sign5= line_sign char5= char_block EQ_SIGN char6= char_block NEW_LINE EQ_SIGN EQ_SIGN EQ_SIGN NEW_LINE char7= char_block sign6= line_sign char8= char_block EQ_SIGN char9= char_block NEW_LINE -> ^( RIDDLE ^( EQ_SIGN ^( $sign1 $char1 $char2) $char3) ^( EQ_SIGN ^( $sign5 $char4 $char5) $char6) ^( EQ_SIGN ^( $sign6 $char7 $char8) $char9) ^( EQ_SIGN ^( $sign2 $char1 $char4) $char7) ^( EQ_SIGN ^( $sign3 $char2 $char5) $char8) ^( EQ_SIGN ^( $sign4 $char3 $char6) $char9) ) )
            // /home/tim/projects/ci/Aufgabe3/symbol.g:31:7: char1= char_block sign1= line_sign char2= char_block EQ_SIGN char3= char_block NEW_LINE sign2= line_sign sign3= line_sign sign4= line_sign NEW_LINE char4= char_block sign5= line_sign char5= char_block EQ_SIGN char6= char_block NEW_LINE EQ_SIGN EQ_SIGN EQ_SIGN NEW_LINE char7= char_block sign6= line_sign char8= char_block EQ_SIGN char9= char_block NEW_LINE
            {
            ...
            // AST REWRITE
            // elements: char5, char8, char9, EQ_SIGN, sign4, char1, EQ_SIGN, char8, char4, EQ_SIGN, char2, char5, char9, char2, sign2, char3, EQ_SIGN, char7, sign3, char3, sign5, char6, EQ_SIGN, char1, EQ_SIGN, char7, sign6, sign1, char4, char6
            // token labels: 
            // rule labels: char9, char8, char7, char6, retval, sign2, sign1, sign4, sign3, char1, char5, sign6, char4, sign5, char3, char2
            // token list labels: 
            // rule list labels: 
            // wildcard labels: 
            retval.tree = root_0;
            ...
            {
                // /home/tim/projects/ci/Aufgabe3/symbol.g:36:6: ^( RIDDLE ^( EQ_SIGN ^( $sign1 $char1 $char2) $char3) ^( EQ_SIGN ^( $sign5 $char4 $char5) $char6) ^( EQ_SIGN ^( $sign6 $char7 $char8) $char9) ^( EQ_SIGN ^( $sign2 $char1 $char4) $char7) ^( EQ_SIGN ^( $sign3 $char2 $char5) $char8) ^( EQ_SIGN ^( $sign4 $char3 $char6) $char9) )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:37:3: ^( EQ_SIGN ^( $sign1 $char1 $char2) $char3)
                {
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:37:13: ^( $sign1 $char1 $char2)
                {
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:38:3: ^( EQ_SIGN ^( $sign5 $char4 $char5) $char6)
                {
                CommonTree root_2 = (CommonTree)adaptor.nil();
                root_2 = (CommonTree)adaptor.becomeRoot(
                stream_EQ_SIGN.nextNode()
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:38:13: ^( $sign5 $char4 $char5)
                {
                CommonTree root_3 = (CommonTree)adaptor.nil();
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:39:3: ^( EQ_SIGN ^( $sign6 $char7 $char8) $char9)
                {
                CommonTree root_2 = (CommonTree)adaptor.nil();
                root_2 = (CommonTree)adaptor.becomeRoot(
                stream_EQ_SIGN.nextNode()
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:39:13: ^( $sign6 $char7 $char8)
                {
                CommonTree root_3 = (CommonTree)adaptor.nil();
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:40:3: ^( EQ_SIGN ^( $sign2 $char1 $char4) $char7)
                {
                CommonTree root_2 = (CommonTree)adaptor.nil();
                root_2 = (CommonTree)adaptor.becomeRoot(
                stream_EQ_SIGN.nextNode()
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:40:13: ^( $sign2 $char1 $char4)
                {
                CommonTree root_3 = (CommonTree)adaptor.nil();
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:41:3: ^( EQ_SIGN ^( $sign3 $char2 $char5) $char8)
                {
                CommonTree root_2 = (CommonTree)adaptor.nil();
                root_2 = (CommonTree)adaptor.becomeRoot(
                stream_EQ_SIGN.nextNode()
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:41:13: ^( $sign3 $char2 $char5)
                {
                CommonTree root_3 = (CommonTree)adaptor.nil();
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:42:3: ^( EQ_SIGN ^( $sign4 $char3 $char6) $char9)
                {
                CommonTree root_2 = (CommonTree)adaptor.nil();
                root_2 = (CommonTree)adaptor.becomeRoot(
                stream_EQ_SIGN.nextNode()
                ...
                // /home/tim/projects/ci/Aufgabe3/symbol.g:42:13: ^( $sign4 $char3 $char6)
                {
                CommonTree root_3 = (CommonTree)adaptor.nil();

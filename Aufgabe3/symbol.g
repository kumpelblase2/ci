...
//char_line
//	:	char_block line_sign char_block EQ_SIGN char_block -> ^(EQ_SIGN ^(line_sign char_block char_block) char_block) ;
...
all	:	char1=char_block sign1=line_sign char2=char_block EQ_SIGN char3=char_block NEW_LINE
		...
		-> ^(RIDDLE
		^(EQ_SIGN ^($sign1 $char1 $char2) $char3)
		^(EQ_SIGN ^($sign5 $char4 $char5) $char6)
		^(EQ_SIGN ^($sign6 $char7 $char8) $char9)
		^(EQ_SIGN ^($sign2 $char1 $char4) $char7)
		^(EQ_SIGN ^($sign3 $char2 $char5) $char8)
		^(EQ_SIGN ^($sign4 $char3 $char6) $char9)
		)
		;
